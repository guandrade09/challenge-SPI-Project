...
export const AiToggleButton = ({ theme = 'dark' }) => {
  ...
  return (
    <button
      ...
      className={`panel-theme-${theme} fixed bottom-6 right-6 z-50 flex items-center justify-center p-3 rounded-full border border-[var(--p-border)] bg-[var(--p-button-bg)] text-[var(--p-text)] shadow-2xl transition-all duration-300 ease-out hover:scale-105 active:scale-95 group ${
        isAiSidebarOpen
